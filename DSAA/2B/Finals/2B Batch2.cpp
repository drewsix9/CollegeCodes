...
public:
  ...
  void sortPrimeAscending() {
    ListNode *i, *j;
    for (i = head; i; i = i->next) {
      for (j = i->next; j; j = j->next) {
        if ((isPrime(i->data) && isPrime(j->data)) && (i->data > j->data)) {
          swap(i->data, j->data);
        }
      }
    }
    cout << "\n[INFO] Successfully Sorted Prime Numbers Linked List in Asending!";
  }

  void sortCompDescending() {
    ListNode *i, *j;
    for (i = head; i; i = i->next) {
      for (j = i->next; j; j = j->next) {
        if ((!isPrime(i->data) && !isPrime(j->data)) && (i->data < j->data)) {
    ...
    cout << "\n[INFO] Successfully Sorted Prime Numbers Linked List in Descending!";
  }
};
...
int main() {
  ...
  while (1) {
    ...
    cout << "\n12 - Sort Prime in Ascending";
    cout << "\n13 - Sort Composite in Descending";
    cout << "\nEnter choice: ";
    cin >> choice;
    switch (choice) {
    case 0:
    ...
    case 11:
      ...
      break;
    case 12:
      li.sortPrimeAscending();
      break;
    case 13:
      li.sortCompDescending();
      break;
    default:
